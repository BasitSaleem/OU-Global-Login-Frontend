    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-between p-4 sm:p-6 lg:p-8">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <span className="text-xs sm:text-sm text-gray-700 hidden sm:block">Already have an account?</span>
          <Link href="/login" className="bg-[#795CF5] hover:bg-[#7C3AED] text-white text-xs sm:text-sm font-bold px-3 sm:px-4 py-1.5 sm:py-2 rounded-full transition-colors">
            Sign In
          </Link>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl sm:rounded-[15px] shadow-[0_0_20px_0_rgba(0,0,0,0.06)] px-4 sm:px-14 py-3 sm:py-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-2 sm:space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4">
                ...
                {/* Last Name field */}
                <div>
                  <label htmlFor="lastName" className="block text-xs sm:text-sm font-medium text-gray-900 mb-1">
                    Last Name
                  </label>
                  <input
                    type="text"
              ...
              {/* Email field */}
              <div>
                <label htmlFor="email" className="block text-xs sm:text-sm font-medium text-gray-900 mb-1">
                  Email
                </label>
                <input
                  type="email"
              ...
              {/* Password field */}
              <div>
                <label htmlFor="password" className="block text-xs sm:text-sm font-medium text-gray-900 mb-1">
                  Password
                </label>
                <div className="relative">
                  ...
                  >
                    <svg width="16" height="12" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 sm:w-4 sm:h-4">
                      ...
                      <path d="M14 9C14 10.6569 12.6569 12 11 12C9.3431 12 8 10.6569 8 9C8 7.3431 9.3431 6 11 6C12.6569 6 14 7.3431 14 9Z" stroke="#C9C8CD" strokeWidth="2"/>
                    </svg>
                  </button>
                </div>
              </div>
            ...
            <div className="space-y-2 sm:space-y-5">
              ...
              <button className="w-full h-8 sm:h-9 flex items-center justify-center gap-1.5 sm:gap-2 border border-[#C9C8CD] rounded-full hover:bg-gray-50 transition-colors cursor-pointer">
                <img
                  ...
                  className="w-3 h-3 sm:w-4 sm:h-4"
                />
                <span className="text-xs sm:text-sm text-gray-900">Continue with Microsoft</span>
              </button>
            </div>
