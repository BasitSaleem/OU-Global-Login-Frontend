...
import { useCreateOrganization, useCheckOrganizationNameAvailability, useCheckSubDomainAvailability } from '@/apiHooks.ts/Organization/organization.api';
...
export default function CreateOrgPage() {
  ...
  const { data: isNameAvailable, isFetching: checkingName } =
    useCheckOrganizationNameAvailability(companyName);

  const { data: isSubAvailable, isFetching: checkingSub } =
    useCheckSubDomainAvailability(selectedProduct === 'OI' ? subDomain : '');

  const products = [
    { id: 'inventory', name: 'OI', fullname: 'Owners Inventory', icon: 'https://api.builder.io/api/v1/image/assets/TEMP/3c4327f1dd595491744f2af966536dd987ec0a0a?width=66' },
    { id: 'marketplace', name: 'OM', fullname: 'Owners Marketplace', icon: 'https://api.builder.io/api/v1/image/assets/TEMP/df8a47bf275bccdb600fe4495f3d4bead9cb844f?width=64' },
    { id: 'analytics', name: 'OA', fullname: 'Owners Analytics', icon: 'https://api.builder.io/api/v1/image/assets/TEMP/72b1ea421112224fa1bea68adcd733be5aa8666b?width=76' },
    { id: 'jungle', name: 'OJ', fullname: 'Owners Jungle', icon: 'https://api.builder.io/api/v1/image/assets/TEMP/78407e1c15d2b695844d30eed5f5358ca8da09f8?width=64' },
  ];
  ...
  const handleSubmit = () => {
    ...
    const payload = { name: companyName, subDomainName: subDomain, product: selectedProduct };
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 sm:p-12 w-full max-w-2xl">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-2">
            <label className="block text-base font-medium">Sub-Domain Name</label>
