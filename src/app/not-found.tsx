...
//   bg-gradient-to-br from-purple-50 to-pink-50 border border-transparent text-black
...
//       {/* Footer */}
//       <div className="text-center relative z-10 pb-2 sm:pb-4">
//         <p className="text-xs text-gray-700 dark:text-white">©2025 Owners Inventory - All rights reserved</p>
//       </div>
//     </div>
//   );
// }
