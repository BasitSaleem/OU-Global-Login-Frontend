...
const InvoicesSection = ({ organization }: InvoicesSectionPropsType) => {
  ...
  return (
    <div className="mb-9">
      <div className="text-center md:text-left mb-9">
        <h1 className="text-heading-1 font-bold pt-8 pb-2">Invoices</h1>
        <p className="text-body-small">
          Invoices are generated every 24 hours and transactions are rolled into
          one invoice during this period.
        </p>
      </div>
      {/* 
      ...
      <InvoiceHistoryTable org={organization} />
    </div>
  );
};
