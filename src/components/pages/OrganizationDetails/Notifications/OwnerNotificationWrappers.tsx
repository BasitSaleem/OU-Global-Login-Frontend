...
export const InventoryNotification: React.FC<Props> = ({
  settings,
  updateNestedSetting,
}) => (
...
export const JungleNotification: React.FC<Props> = ({
  settings,
  updateNestedSetting,
}) => (
  <OwnerNotificationPanel
...
export const MarketplaceNotification: React.FC<Props> = ({
  settings,
  updateNestedSetting,
}) => (
  <OwnerNotificationPanel
...
export const AnalyticsNotification: React.FC<Props> = ({
  settings,
  updateNestedSetting,
}) => (
  <OwnerNotificationPanel
