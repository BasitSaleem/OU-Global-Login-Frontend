...
export default function NotificationsHeaderControls({
  ...
  return (
    <div className="p-2 md:p-3 pb-3 border-b border-gray-100 bg-white dark:!bg-gray-800 dark:!border-gray-700 flex-shrink-0 flex items-center justify-between">
      <div className="flex items-center gap-2">
        <button onClick={() => setSidebarOpen(true)} className="text-gray-600 cursor-pointer hover:text-black md:hidden">
          <HiMenu size={16} />
        </button>
        <h2 className="text-body-medium-bold text-black dark:!text-white">Latest</h2>
      </div>
      ...
      <div className="flex items-center gap-1 sm:gap-2 ">
        ...
        >
          ...
          <span className="hidden sm:inline dark:!text-white">Only show Unread</span>
        </span>

        {/* Pill switch */}
        <div
          onClick={() => setOnlyUnread(!onlyUnread)}
          className={`rounded-full p-0.5 cursor-pointer transition-colors ${onlyUnread ? 'bg-[#795CF5]' : 'bg-gray-200 dark:bg-gray-600'
