    ...
    <div className="space-y-8">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-500">
          Configure your domain and review your selected plan
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-sm font-semibold text-text uppercase tracking-wider">
            Selected Products
          </label>
          <div className="flex">
            {productInfo && (
          ...
          {selectedProduct === "OI" && (
            <div className="space-y-1">
              ...
              <p className="text-lg font-bold text-text">
                {subDomain}.
                {process.env.NEXT_PUBLIC_DOMAIN_NAME || "ownersanalytics.com"}
              </p>
            </div>
          )}
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <span className="text-gray-600 font-medium">
              {productInfo?.fullname} •{" "}
              <span className="text-text font-bold">{selectedPlan?.type}</span>
            </span>
            <button
              onClick={onBack}
