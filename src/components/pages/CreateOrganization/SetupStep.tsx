...
import { ChevronLeft, ChevronRight, Store, Factory, ShoppingCart, Layers, ArrowLeft, Check } from "lucide-react";
...
// mode is active. OP has 3 simple tiers, all with a 14-day free trial and no card
// required (GHL bills OP; the setup fee is arranged separately with the team).
