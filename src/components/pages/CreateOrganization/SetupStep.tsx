...
export const SetupStep: React.FC<SetupStepProps> = ({
  ...
  selectedPlanId = "d755fe7d-4372-426c-af33-e63b71a6521f",
  setSelectedPlanId,
  onBack,
  onCreate,
  creatingOrg,
    ...
    <div className="space-y-4 ">
      <div className="text-center md:text-left">
        ...
        <p className="text-text-secondary">
          Configure your domain and choose a plan for each product
        </p>
      </div>
        ...
        <div className="flex flex-wrap gap-3">
          {PRODUCTS.map((product) => {
            ...
            return (
              <div
                key={product.name}
                className={`flex items-center gap-3 px-5 py-2.5 rounded-xl border-border border transition-all ${
                  isSelected
      ...
      <div className="space-y-2">
        <div className="space-y-0">
          <div className="flex flex-col w-full">
            <p className="text-text pb-1 text-nowrap">
